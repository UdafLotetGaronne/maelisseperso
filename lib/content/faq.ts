export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "Ça dépend du projet, mais comptez en moyenne 3 à 6 semaines entre notre premier échange et la mise en ligne. Le plus long, c'est souvent de rassembler vos contenus (textes, photos) : une fois qu'on a tout, la création va plus vite.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Pas du tout, c'est même la majorité des cas. Beaucoup de clients arrivent avec juste l'envie de mieux communiquer, sans savoir par où commencer. C'est justement mon travail de vous aider à y voir clair et de vous proposer ce qui a vraiment du sens pour votre activité.",
  },
  {
    question: "Travaillez-vous avec les indépendants et petites structures, ou seulement les entreprises ?",
    answer:
      "Toutes les tailles. J'accompagne aussi bien des indépendants et des associations que des commerces ou des entreprises plus installées. Ce qui compte, c'est le projet, pas la taille de la structure.",
  },
  {
    question: "Je peux vous confier juste un besoin ponctuel, ou faut-il un accompagnement sur la durée ?",
    answer:
      "Les deux sont possibles. Certains clients me confient un projet ponctuel (un logo, un site, une campagne), d'autres préfèrent un accompagnement régulier sur leurs réseaux sociaux par exemple. On construit ça ensemble, selon vos besoins.",
  },
  {
