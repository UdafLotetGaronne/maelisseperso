  ...
  return (
    <section className="relative overflow-hidden pb-16 pt-8 sm:pt-12 lg:pb-24 lg:pt-16">
      ...
      <Container className="relative">
        ...
        <div className="mt-6 grid grid-cols-1 items-start gap-10 lg:mt-8 lg:grid-cols-12">
        ...
        <div className="mt-10 grid grid-cols-1 gap-8 lg:mt-14 lg:grid-cols-12 lg:items-end lg:gap-6">
          <p className="col-span-12 max-w-xl font-sans text-base leading-relaxed text-green-950/80 sm:text-lg lg:col-span-6">
